...
`В настоящий момент` продолжаю изучать веб-технологии, занимаюсь своими pet-проектами и нарабатываю себе портфолио на фрилансе. Параллельно с этим ищу работу на позицию `Front-End Developer (junior)`.
...
`До 2022 г.` 20 лет отработал юристом в торгово-производственных и консалтинговых компаниях. Специализировался на сделках и бизнес-процессах. Оформлял договорную и нормативно-распорядительную документацию. Защищал интересы доверителей в судах и госорганах.

**Почему сменил профессию**  

`В 2021 г.` занимался составлением документов для операторов персональных данных. Понял, что мне не хватает технических знаний. Чтобы восполнить пробелы, пришлось много общаться с IT-специалистами. Они-то и посоветовали мне выучиться на веб-разработчика.
...
- отслеживать изменения законодательства (преимущественно в сфере информационных технологий);
...
Но, это долгосрочные планы, которые могут корректироваться в зависимости от обстоятельств. Многое будет зависеть от нужд и планов компании, в которой мне посчастливится работать.
