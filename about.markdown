...
`В настоящий момент` продолжаю изучать веб-технологии, занимаюсь своими pet-проектами, нарабатываю себе портфолио на фрилансе и параллельно ищу работу на позицию `Front-End Developer (junior)`.
...
Но, это долгосрочные планы, которые могут корректироваться в зависимости от обстоятельств. Многое будет зависеть от нужд и перспектив компании, в которой мне посчастливится работать.
